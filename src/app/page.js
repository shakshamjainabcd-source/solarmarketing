...
export default function Home() {
  ...
  return (
    <div className="bg-matteBlack text-white min-h-screen relative font-poppins selection:bg-luxuryGold selection:text-black">
      ...
      <header className="sticky top-0 z-50 bg-matteBlack/90 backdrop-blur-md border-b border-luxuryGold/10">
        <div className="max-w-7xl mx-auto px-4 py-3 flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex items-center gap-6">
            <img src="/image.png" alt="Black and White Solar Marketing Logo" width={160} height={70} className="object-contain h-[70px]" />
            <div className="h-10 w-px bg-luxuryGold/20 hidden md:block" />
            <img src="/image_2.png" alt="4Square Logo" width={120} height={70} className="object-contain h-[70px]" />
          </div>
      ...
      <section id="products" className="bg-zinc-950/60 py-24 border-t border-zinc-900">
        <div className="max-w-7xl mx-auto px-4">
          ...
          {filteredProducts.length === 0 && (
            <p className="text-center text-zinc-500 text-sm mt-12">No products match your specific query filter. Contact shop directly for custom orders.</p>
          )}
        </div>
      </section>
            ...
            <form onSubmit={handleReviewSubmit} className="space-y-4">
              <div>
                ...
                <input 
                  ...
                  className="w-full bg-zinc-950 border border-zinc-800 rounded px-3 py-2 text-sm focus:outline-none focus:border-luxuryGold" 
              ...
              <div>
                ...
                <textarea 
                  ...
                  className="w-full bg-zinc-950 border border-zinc-800 rounded px-3 py-2 text-sm focus:outline-none focus:border-luxuryGold" 
                  placeholder="Share your experience working with our services..."
                />
              </div>
              <button type="submit" className="w-full py-2.5 bg-bloodRed text-white text-xs font-bold uppercase rounded tracking-wider hover:bg-red-700 transition-all">
                Submit Review
              </button>
            </form>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              <a href="https://maps.google.com" target="_blank" className="px-5 py-2.5 bg-zinc-900 border border-zinc-700 text-xs rounded font-medium text-white hover:border-luxuryGold transition-all">
                Open in Google Maps
              </a>
              <a href="https://maps.google.com" target="_blank" className="px-5 py-2.5 bg-bloodRed text-xs rounded font-medium text-white hover:bg-red-700 transition-all">
                Get Directions
              </a>
            </div>
          </div>
          <div className="w-full h-72 rounded-xl overflow-hidden border border-zinc-800 bg-zinc-900 relative">
            <iframe 
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3825.213264426569!2d80.6151478!3d16.515286!2m3!1f0!2f0!3f0!3m2!1i1020!2m2!1y100!4f13.1!3m3!1m2!1s0x3a35eff4fdf9bc3b%3A0x28af8d1a123fcd!2sTarapet%2C%20Vijayawada%2C%20Andhra%20Pradesh!5e0!3m2!1sen!2sin!4v1700000000000"
      ...
      <section id="contact" className="bg-zinc-950 py-16 border-t border-zinc-900">
        <div className="max-w-4xl mx-auto px-4 text-center space-y-8">
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            {[
              { label: 'Primary Contact', num: '9849131353' },
              { label: 'Wholesale Orders', num: '9490337211' },
              { label: 'Spares Support', num: '9441120146' }
            ].map((ph, idx) => (
              <div key={idx} className="p-4 bg-zinc-900 border border-zinc-800 rounded-lg">
                ...
                <a href={`tel:${ph.num}`} className="text-luxuryGold hover:text-white font-medium text-base tracking-wide transition-colors">
                  +91 {ph.num}
                </a>
              </div>
            ))}
          ...
          <div className="inline-block px-6 py-2 bg-zinc-900 border border-zinc-800 rounded-full text-xs text-zinc-400">
            📅 <span className="text-white font-semibold">Business Hours:</span> Open Daily (9:00 AM to 9:00 PM IST)
          </div>

          <div className="pt-4 text-xs text-zinc-600 font-mono tracking-widest">
            WEBSITE VISITORS: <span className="text-zinc-400 font-bold">{visitorCount}</span>
          </div>
        </div>
      </section>

      {/* --- FOOTER --- */}
      <footer className="border-t border-zinc-900 bg-matteBlack text-zinc-500 text-xs py-12">
        <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-3 gap-8 items-center text-center md:text-left">
          <div>
            <h4 className="text-sm font-bold text-white tracking-widest mb-2">SOLAR MARKETING</h4>
            <p className="max-w-xs leading-relaxed text-zinc-400">
              11-31-86 Park Road, Near Shankar Cafe Building, Tarapet, Vijayawada, AP - 520001
            </p>
          </div>
          <div className="flex justify-center gap-6 text-zinc-400">
            <a href="#home" className="hover:text-luxuryGold">Top</a>
            <a href="#products" className="hover:text-luxuryGold">Products</a>
            <a href="#about" className="hover:text-luxuryGold">About</a>
            <a href="#reviews" className="hover:text-luxuryGold">Reviews</a>
          </div>
          <div className="md:text-right text-zinc-400">
            <p>&copy; 2026 Solar Marketing. All rights reserved.</p>
            <p className="text-[10px] text-zinc-600 mt-1">Premium Retail Layout Design</p>
          </div>
        </div>
      </footer>
      ...
      <a 
        href={whatsappLink("Hello Solar Marketing,\nI am interested in your products.")} 
        target="_blank" 
      ...
      <button 
        ...
        className="fixed bottom-6 left-6 z-50 bg-zinc-900 border border-luxuryGold/30 text-luxuryGold p-2.5 rounded-md hover:bg-bloodRed hover:text-white transition-all text-xs font-bold"
      >
        ▲ TOP
      </button>
      ...
      {selectedImg && (
        <div className="fixed inset-0 bg-black/95 z-50 flex items-center justify-center p-4 cursor-zoom-out" onClick={() => setSelectedImg(null)}>
          <div className="relative max-w-4xl max-h-[85vh]">
            <img src={selectedImg} alt="Enlarged View" className="w-full h-full object-contain rounded-lg border border-luxuryGold/20" />
            <button className="absolute -top-10 right-0 text-white text-sm tracking-widest font-mono uppercase bg-zinc-900 px-3 py-1 rounded">✕ Close</button>
          </div>
        </div>
      )}
